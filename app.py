...
composition_dict = {
 "Zの法則（左上から右下へ視線を誘導・王道）": (
        ...
        "CRITICAL RULE: DO NOT draw any visible connecting lines, light trails, or arrows. " # 👈 線は絶対出さない！
        "Instead, use clean, elegant 'solid banners' or 'semi-transparent panes' for text to create a high-end editorial look. " # 👈 「看板」でおしゃれに見せる
        "The character must be a full-body or upper-body visual anchor, integrated naturally into the center or corner to bridge the visual flow. " # 👈 生首禁止！
