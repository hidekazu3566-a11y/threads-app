...
composition_dict = {
 "Zの法則（左上から右下へ視線を誘導・王道）": (
        "A sophisticated, professional social media infographic layout following the Z-shaped flow. "
        "CRITICAL RULE: DO NOT draw any visible connecting lines, light trails, or arrows between elements. " # 👈 線は絶対に出さない！
        "Instead, use clean, elegant 'semi-transparent panes' or 'solid banners' for text to create a high-end editorial look. " # 👈 看板でおしゃれに整理
        "The character must be a full-body or upper-body visual anchor, integrated naturally into the center or corner to bridge the visual flow. "
        "Ensure clear spatial balance and premium whitespace, creating a structured, polished design that feels like a professional business graphic. "
        "CRITICAL EMOTION-EXPRESSION SYNC RULE: The AI MUST analyze the core emotion of the provided text. It MUST dramatically adapt the main subject's facial expressions and poses to perfectly match that specific mood."
    ),
