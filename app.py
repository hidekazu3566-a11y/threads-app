...
composition_dict = {
  "Zの法則（左上から右下へ視線を誘導・王道）": (
        "A clean, standard professional layout following the Z-shaped eye-tracking pattern. "
        "CRITICAL RULE: DO NOT draw any visible connecting lines, light trails, arrows, or paths between elements. " # 👈 「線を描くな」という強力な禁止令
        "Arrange text blocks and the character to naturally guide the eye from top-left, to top-right, across the center, and settling at the bottom-right. "
        "Focus on clear spatial balance and high readability on a clean background, without any artistic 'swish' or decorative connection effects."
    ),
